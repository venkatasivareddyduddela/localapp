...
<script>
  const shopsByCity = {
    Markapuram: [
      { name: "Funny", image: "funny1.jpg", link: "shop_collection.php?shop=funny" },
      { name: "Siva", image: "siva.jpg", link: "shop_collection.php?shop=siva" },
      { name: "Ragavendra", image: "ragavendra.jpg", link: "shop_collection.php?shop=ragavendra" },
      { name: "Kishore", image: "kishore.jpg", link: "shop_collection.php?shop=kishore" }
    ],
    Ongole: [
      { name: "Men's Fashion", image: "mens.jpg", link: "shop_collection.php?shop=mens" },
      { name: "Trendy Wear", image: "trendy.jpg", link: "shop_collection.php?shop=trendy" },
      { name: "Local Hub", image: "local.jpg", link: "shop_collection.php?shop=local" },
      { name: "Fashion Fix", image: "fix.jpg", link: "shop_collection.php?shop=fix" }
    ],
    Guntur: [],
    Nellore: []
  };
